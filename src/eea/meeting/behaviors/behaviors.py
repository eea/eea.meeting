...
class EEAMeetingConstrainTypes(ConstrainTypesBehavior):
    ...
    def allowedContentTypes(self, context=None):
        ...
        subscribers = portal.portal_types.get('Subscribers')
        if context is None:
        ...
        if (IEEAMeeting.providedBy(context) and
...
class IEEAMeetingConstrainTypes(ISelectableConstrainTypes):
